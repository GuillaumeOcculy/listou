...
class ProductListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_list" do
    assert_difference("ProductList.count") do
      post product_lists_url, params: { product_list: { favorited: @product_list.favorited, name: @product_list.name, slug: @product_list.slug, user_id: @product_list.user_id } }
    end
  ...
  test "should update product_list" do
    patch product_list_url(@product_list), params: { product_list: { favorited: @product_list.favorited, name: @product_list.name, slug: @product_list.slug, user_id: @product_list.user_id } }
